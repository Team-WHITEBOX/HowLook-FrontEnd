...
import 'package:howlook/review/component/creater_review_card.dart';

class CreaterReview extends ConsumerWidget {
  const CreaterReview({Key? key}) : super(key: key);

  Future<Map<String, dynamic>> paginateCreaterReview(WidgetRef ref) async {
    final dio = Dio();
        ...
        child: SingleChildScrollView(
            child: SafeArea(
                child: FutureBuilder<Map<String, dynamic>>(
                    future: paginateCreaterReview(ref),
                    builder: (_, AsyncSnapshot<Map<String, dynamic>> snapshot) {
                      ...
                      return CreaterReviewCard.fromModel(model: pItem);
                    }))));
  }
}
