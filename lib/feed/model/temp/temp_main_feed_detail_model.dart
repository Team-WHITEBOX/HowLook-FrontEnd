...
import 'package:howlook/feed/model/temp/temp_main_feed_model.dart';
import 'package:howlook/feed/model/temp/temp_userinfo_model.dart';
import 'package:howlook/feed/model/userinfomodel.dart';

class TempMainFeedDetailModel extends TempMainFeedModel {
  // 좋아요 수
  final int likeCount;
  // 본인의 좋아요 체크 여부
  final bool like_chk;
  ...
  factory TempMainFeedDetailModel.fromJson({
    required Map<String, dynamic> json,
  }) {
    return TempMainFeedDetailModel(
